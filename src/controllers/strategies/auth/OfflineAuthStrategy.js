...
class OfflineStrategy extends AuthSesionInterface {
    ...
    async login(userName, password) {
        ...
        // ¡Ahora usamos usersService que ya está listo!
        const data = await usersService.getByUserAndPassword(userName, password);
